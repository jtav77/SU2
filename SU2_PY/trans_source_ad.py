...
# Convert C++ to C
source_routine   = 'CSourcePieceWise_TransLM::ComputeResidual_TransLM'
source_directory = '/home/aniket/su2/trunk/SU2_CFD/src'
source_location  = source_directory + '/numerics_direct_transition.cpp'

convert_cpp2c(source_routine, source_location, overwrite=True)

# Differentiate C routine
routine_name = 'CSourcePieceWise_TransLM__ComputeResidual_TransLM'
invars  = ['TransVar_i']
outvars = ['val_residual']

croutinesdir = '/home/aniket/su2/trunk/SU2_CFD/src/c_routines'
file_list = [os.path.join(croutinesdir, 'CSourcePieceWise_TransLM__ComputeResidual_TransLM.c')]
